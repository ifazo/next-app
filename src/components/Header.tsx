              ...
              <div className="border-b border-gray-200">
                <div className="h-16 flex items-center justify-between">
                  ...
                  <div className="flex-1 flex items-center justify-end">
                    <a href="/auth/login" className="hidden text-sm font-medium text-gray-700 hover:text-gray-800 lg:block">
                      Login
                    </a>
                    ...
                    <div className="flex items-center lg:ml-8">
                      ...
                      <a href="/auth/register" className="hidden text-sm font-medium text-gray-700 hover:text-gray-800 lg:block">
                        Register
                      </a>
